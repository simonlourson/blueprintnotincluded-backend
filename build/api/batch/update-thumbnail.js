    ...
    UpdateThumbnail.prototype.updateThumbnail = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pixi_backend_1.PixiBackend.initTextures()];
                    case 1:
                        _a.sent();
                        blueprint_1.BlueprintModel.model.find({}).sort({ createdAt: 1 })
                            ...
                            var _loop_1 = function (index) {
                                ...
                                var newThumbnail = pixi_backend_1.PixiBackend.pixiBackend.generateThumbnail(angularBlueprint);
                                // Release memory
                                mdbBlueprint = null;
